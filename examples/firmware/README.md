...
* * Für die verschiedenen Module gibt es dezitierte Verzeichnisse, in denen sich die FW-Dateien befinden, die im esptool ausgewählt werden müssen lt. Bild und richtiger Adresse und anschließend **`[PROGRAM]`** ... nach dem Flashen **RST/RESET** Taste am Modul drücken.
